...
import org.eclipse.fennec.emf.editor.command.ResourceCommand;

/**
 * This is the item provider adapter for a
 * {@link org.eclipse.emf.ecore.resource.Resource} object.
 */
public class ResourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<?> getChildren(Object object) {
		// Don't include controlled children here, they'll show up under their
		// container.
		//
	...
	/**
	 * Copies the contents of the resource to an array while holding a lock on the
	 * resource and subsequently its resource set, if the resource is contained by a
	 * resource set.
	 * 
	 * @since 2.9
	 */
	...
	public Object getImage(Object object) {
		Resource resource = (Resource) object;
		Object image = URI.createURI(getResourceLocator().getImage("full/obj16/Resource").toString() + "#"
	...
	/**
	 * This handles notification by calling {@link #fireNotifyChanged(Notification)
	 * fireNotifyChanged}.
	 */
	@Override
	public void notifyChanged(Notification notification) {
		...
		// When an object is controlled, the only change will be in the new resource's
		// contents, so it must
	...
	public Command createCommand(Object object, EditingDomain domain, Class<? extends Command> commandClass,
		...
		if (commandClass == CreateChildCommand.class) {
			EClass eClass = (EClass) commandParameter.getValue();
			ResourceCommand command = new ResourceCommand(domain, (Resource) object, EcoreUtil.create(eClass));
			command.setLabel(eClass.getName() + " - (" + eClass.getEPackage().getName() + ")");
			return command;
		}
